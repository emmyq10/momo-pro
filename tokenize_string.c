...
/**
 * strtow -This takes a string and seperates its words
 *
 ...
 *
 * @delims: The pointer to null terminated array of delimitors
 *
 ...
 *
 * @str: The string to get word length from current word
 * @delims: delimitors to use to delimit words
 *
 * Return: The word length of current word
 */
